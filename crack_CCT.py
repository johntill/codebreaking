...
quad_fitness = ns.NgramScore('english_quadgrams.txt')

with open("ctkey12cipherICT.txt") as f:
    text = f.read()
...
def bi_score(text):
    scores = {}
    bi_fitness = ns.NgramScore('english_bigrams.txt')
...
def tri_score(text):
    scores = {}
    tri_fitness = ns.NgramScore('english_trigrams.txt')
